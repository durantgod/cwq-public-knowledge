...
public class ExecutorBuilder {
    ...
    private static ThreadPoolExecutor build(ExecutorBuilder builder) {
        ...
        RejectedExecutionHandler handler = null == builder.handler ? builder.getRejectedDefaultHandler() : builder.handler;
    ...
    RejectedExecutionHandler getRejectedDefaultHandler() {
        return (r, executor) -> System.out.println("自定义拒绝策略！");
    }
}
